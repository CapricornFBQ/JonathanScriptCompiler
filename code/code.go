...
var definitions = map[Opcode]*Definition{
	...
	OpIndex:         {"OpIndex", []int{}},
	OpCall:          {"OpCall", []int{1}}, // operand: hold the number of arguments
	...
	OpClosure:    {"OpClosure", []int{2, 1}}, // the first operand is the constant indesx,the second operand specifies the number of free variables
}
...
func Make(op Opcode, operands ...int) []byte {
	...
	for i, o := range operands {
		...
		case 1:
			instruction[offset] = byte(o) // the bit content of a Byte is same in big endian and little endian
		}
		offset += width
	}
	return instruction
